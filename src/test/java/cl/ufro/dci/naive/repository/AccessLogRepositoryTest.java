...
import static cl.ufro.dci.naive.repository.util.UtilTest.DATA_JSON_ACCESS;
import static cl.ufro.dci.naive.repository.util.UtilTest.DATA_JSON_ACCESSLOGS;
...
class AccessLogRepositoryTest {
    ...
    void initEach() throws IOException {
        AccessLog[] accessLogs = new ObjectMapper().readValue(DATA_JSON_ACCESSLOGS,AccessLog[].class);
        Access[] accesses = new ObjectMapper().readValue(DATA_JSON_ACCESS,Access[].class);
